    ...
    <main>
      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            <p className="mb-5 text-lg leading-8 text-[#4B4B4B]">
      ...
      <Section>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <h3 className="mb-4 text-2xl font-serif">Dance</h3>
          ...
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <h3 className="mb-4 text-2xl font-serif">Musical Theatre</h3>
            <p className="leading-7 text-[#4B4B4B]">
          ...
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <h3 className="mb-4 text-2xl font-serif">Music Lessons</h3>
            <p className="leading-7 text-[#4B4B4B]">
      ...
      <Section>
        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <div className="mb-5 text-5xl font-serif text-[#6E5A73]/80">01</div>
            <h3 className="mb-3 text-2xl font-serif">Explore</h3>
            <p className="leading-7 text-[#4B4B4B]">
          ...
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <div className="mb-5 text-5xl font-serif text-[#6E5A73]/80">02</div>
            <h3 className="mb-3 text-2xl font-serif">Ask Questions</h3>
            <p className="leading-7 text-[#4B4B4B]">
          ...
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <div className="mb-5 text-5xl font-serif text-[#6E5A73]/80">03</div>
            <h3 className="mb-3 text-2xl font-serif">Attend the First Class</h3>
            <p className="leading-7 text-[#4B4B4B]">
          ...
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <div className="mb-5 text-5xl font-serif text-[#6E5A73]/80">04</div>
            <h3 className="mb-3 text-2xl font-serif">Grow Over Time</h3>
            <p className="leading-7 text-[#4B4B4B]">
      ...
      <Section>
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            ...
            <h2 className="mb-4 text-3xl font-serif">What students may need</h2>
      ...
      <Section>
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-[28px] bg-white p-8 shadow-sm">
            <h2 className="mb-4 text-3xl font-serif">About competitive dance</h2>
            <p className="leading-7 text-[#4B4B4B]">
