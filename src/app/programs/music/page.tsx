...
export default function MusicPage() {
  const page = getProgramDetailPage("music");
  const instructors = getInstructorsByDiscipline("music");
      ...
      <Section className="bg-[#EFE8E3]">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg text-[#4B4B4B]">
            Our music instructors help students grow through focused,
            personalized instruction that builds skill, confidence, and
